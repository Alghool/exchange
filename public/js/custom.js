...
(function ($) {
    ...
    $(window).on('load', function () {
        if (typeof $('.slider-wrapper').flexslider === "function") {
    ...
    //ThemeSlider  ************************************
    //*************************************************
    if (typeof  $('.theme-flexslider').flexslider === "function") {
    ...
    if (typeof  $(".theme-owlslider").owlCarousel === "function") {
    ...
    //ResponsiveMenu  *********************************
    //*************************************************
    if (typeof  $('#hdr-wrapper').scrollToFixed === "function") {
    ...
    //*************************************************
    //Testimonial Slider
    if (typeof  $("#testimonial-slider").owlCarousel === "function") {
